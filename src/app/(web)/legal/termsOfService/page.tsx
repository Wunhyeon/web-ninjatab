  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <ul className="list-disc ml-6 mb-4">
        ...
        <li>Not use the service for any unauthorized or illegal activities</li>
      </ul>
      ...
      <p className="mb-4">
        ...
        posted on our website. Your continued use of the service after such
      ...
      <ul className="list-disc ml-6 mb-4">
        ...
        <li>Email: xhwogusxh@gmail.com</li>
      </ul>
    </div>
  );
};
